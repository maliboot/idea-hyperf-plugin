package io.maliboot.devkit.idea.lombok.typeProvider
...
import io.maliboot.devkit.idea.lombok.extend.isExcludeDir
...
//            if (!classRefFQN.contains("\\")) {
//                logger.error("类型解析异常：$classRefType")
//                return null
//            }
//            classRefFQN = classRefFQN.substring(classRefFQN.indexOf('\\') + 1)
//        }
        when (classReference) {
